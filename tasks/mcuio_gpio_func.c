...
static const unsigned int PROGMEM gpio_configs_length = sizeof(gpio_configs);
...
static const unsigned int PROGMEM gpio_ro_range_length = sizeof(gpio_ro_range);
...
static const unsigned int PROGMEM gpio_data_length = 4;
