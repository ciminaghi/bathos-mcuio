...
#define REG_SYST_CSR	(0xe000e010 / sizeof(uint32_t))

#define CSR_ENABLE	0x1
#define CSR_TICKINT	0x2
#define CSR_CLOCKSOURCE 0x4

#define REG_SYST_RVR	(0xe000e014 / sizeof(uint32_t))
#define REG_SYST_CVR	(0xe000e018 / sizeof(uint32_t))
#define REG_SYST_CALIB	(0xe000e01c / sizeof(uint32_t))
