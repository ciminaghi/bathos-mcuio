...
static struct freescale_uart_priv uart0_priv = {
	.dev = &__udev0,
	.platform_data = &uart0_pdata,
};

static struct freescale_uart_priv uart1_priv = {
	.dev = &__udev1,
	.platform_data = &uart1_pdata,
};

static struct freescale_uart_priv uart2_priv = {
	.dev = &__udev2,
